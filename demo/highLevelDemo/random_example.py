...
def test2():
    ...
    print ("使用默认种子生成随机数：", random.random())
    random.seed()
    print ("使用默认种子生成随机数2：", random.random())
    print ("使用默认种子生成随机数2：", random.random())
    ...
    print ("使用整数 10 种子生成随机数：", random.random())
    random.seed(10)
    print ("使用整数 10 种子生成随机数2：", random.random())
    print ("使用整数 10 种子生成随机数2：", random.random())
    ...
    print ("使用字符串种子生成随机数：", random.random())
    random.seed("hello",2)
    print ("使用字符串种子生成随机数2：", random.random())
    print ("使用字符串种子生成随机数2：", random.random())
test2()

'''
结果：
使用默认种子生成随机数： 0.9279122398612331
使用默认种子生成随机数： 0.5992228536708999
使用默认种子生成随机数2： 0.20042746060090377
使用默认种子生成随机数2： 0.1607532714679728
使用整数 10 种子生成随机数： 0.5714025946899135
使用整数 10 种子生成随机数： 0.4288890546751146
使用整数 10 种子生成随机数2： 0.5714025946899135
使用整数 10 种子生成随机数2： 0.4288890546751146
使用字符串种子生成随机数： 0.3537754404730722
使用字符串种子生成随机数： 0.6631985810268619
使用字符串种子生成随机数2： 0.3537754404730722
使用字符串种子生成随机数2： 0.6631985810268619
'''

# 得出结论，使用默认种子生成随机数，是真随机，使用固定值种子生成随机数，是伪随机
