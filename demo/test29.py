...
print('队列状态：',queue) # deque(['a','b','c'])

#  从队首移除元素
first_ele = queue.popleft()
print('移除的元素：',first_ele)
print('队列状态：',queue) # deque(['b','c'])
...
print(queue.dequeue())
print(queue.dequeue())
# print(queue.dequeue()) # IndexError: dequeue from empty queue
...
freshfruit = ['  banana', '  loganberry ', 'passion fruit  ']
print([item.strip() for item in freshfruit ]) # ['banana', 'loganberry', 'passion fruit']
...
list2 = [2,4,6]
print([[i for i in list2] for x in range(3)]) # [[2, 4, 6], [2, 4, 6], [2, 4, 6]]
