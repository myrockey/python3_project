...
list0 = ['Google', 'Runoob', 1997, 2000]

print ("第三个元素为 : ", list0[2])
list0[2] = 2001
print ("更新后的第三个元素为 : ", list0[2])
...
b1 = [2,3]
c1 = [2,3]
print("operator.eq(a,b):",operator.eq(a1,b1))
print("operator.eq(c,b):",operator.eq(c1,b1))
...
print (len(lst1)) # 3
lst2 = list(range(5)) # 创建一个 0-4 的列表
print (len(lst2)) # 5
