...
shutil.move('database_copy.db','./tmp/database_copy.db')
...
#命令行参数
import sys
print(sys.argv) # 执行命令："D:/Program Files/Python313/python.exe" d:/projects/python3_project/demo/test52.py one two three
'''
结果：
['d:/projects/python3_project/demo/test52.py', 'one', 'two', 'three']
'''
...
def stmp_sendmail():
    ...
    server.sendmail('soothsayer@example.org', 'jcaesar@example.org',
        ...
        Beware the Ides of March.""")
    server.quit()
# stmp_sendmail() # 需要本地有一个在运行的邮件服务器
...
now = datetime.date(2023, 7, 17)
birthday = datetime.date(1964,7,31)
age = now - birthday
print(age.days)
'''
结果：
10-20-25. 20 Oct 2025 is a Monday on the 20 day of October.
21535
'''
...
'''
结果：
0.013812199933454394
0.010323400027118623
