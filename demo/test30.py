...
# import test.support2 as support2 # 从test包导入模块
# from test.support2 import print_func as print_func2
# import test.support2
# import test.hello
from test import *

support.print_func('导入模块')
print_func('模块导入具体函数')
# support2.print_func('从test包导入模块并重命名')
# print_func2('从test包导入具体模块的具体函数')
# test.support2.print_func('导入test包的具体模块')
# test.hello.say_hello('导入test包的具体模块') 
support2.print_func('从test包导入*')

# 从test包导入* 需确认__init__.py 中的 _all__定义是否包含hello模块
# hello.say_hello('从test包导入*') # NameError: name 'hello' is not defined
'''
