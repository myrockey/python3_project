...
os.chdir('D:\projects\python3_project\\tmp') 
print('新的工作目录：',os.getcwd())
print('目录内容：',os.listdir())
print(os.mkdir('new_dir')) # 无返回值，已存在目录，再创建会报错 FileExistsError: [WinError 183] 当文件已存在时，无法创建该文件。: 'new_dir'
print(os.rmdir('new_dir')) # 无返回值，不存在魔力，删除会报错 FileNotFoundError: [WinError 2] 系统找不到指定的文件。: 'new_dir'
# os.remove('demo.ttt') # FileNotFoundError: [WinError 2] 系统找不到指定的文件。: 'demo.ttt'
# os.rename('demo.txt','new_demo.txt') # FileNotFoundError: [WinError 2] 系统找不到指定的文件
# 获取环境变量
print('Path 目录：',os.getenv('Path'))
# 执行系统命令
os.system('ipconfig')
